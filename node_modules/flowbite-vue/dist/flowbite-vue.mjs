import { reactive as ts, onBeforeMount as rs, onBeforeUnmount as os, defineComponent as C, openBlock as u, createElementBlock as g, unref as m, renderSlot as v, computed as p, ref as V, onMounted as We, normalizeClass as w, createCommentVNode as z, createElementVNode as f, useAttrs as de, mergeProps as ne, useSlots as Ue, toRefs as J, toDisplayString as O, createBlock as W, resolveDynamicComponent as te, withCtx as G, resolveComponent as he, normalizeProps as Se, Fragment as Y, renderList as Me, withModifiers as wt, isRef as Xt, getCurrentScope as ss, onScopeDispose as ns, getCurrentInstance as ao, nextTick as er, watch as _t, watchEffect as as, createTextVNode as re, Comment as ls, toRef as lt, createVNode as Ae, Transition as lo, normalizeStyle as rt, pushScopeId as io, popScopeId as uo, withKeys as co, provide as ue, inject as ee, withDirectives as Te, vShow as is, guardReactiveProps as po, h as ft, TransitionGroup as ds, withScopeId as us, vModelCheckbox as fo, vModelDynamic as cs, vModelRadio as ps, vModelText as go, vModelSelect as fs } from "vue";
...
const gs = ["data-accordion-id"], jp = /* @__PURE__ */ C({
  __name: "FwbAccordion",
  props: {
  ...
  setup(e) {
    const t = e, r = ho();
    return pt(r, { ...t }), (o, s) => (u(), g("div", { "data-accordion-id": m(r) }, [
      v(o.$slots, "default")
    ], 8, gs));
  }
});
...
function ae(e) {
  return Be(e) || zs.has(e) || Ps.test(e) || Ut(e);
}
function Ut(e) {
  return Ee(e, "length", Ns);
}
function Bs(e) {
  return Ee(e, "size", wo);
}
function Os(e) {
  return Ee(e, "position", wo);
}
function Ms(e) {
  return Ee(e, "url", Rs);
}
function gt(e) {
  return Ee(e, "number", Be);
}
function Be(e) {
...
function js() {
  var e = D("colors"), t = D("spacing"), r = D("blur"), o = D("brightness"), s = D("borderColor"), n = D("borderRadius"), a = D("borderSpacing"), l = D("borderWidth"), i = D("contrast"), d = D("grayscale"), b = D("hueRotate"), h = D("invert"), y = D("gap"), c = D("gradientColorStops"), x = D("gradientColorStopPositions"), k = D("inset"), $ = D("margin"), T = D("opacity"), S = D("padding"), I = D("saturate"), _ = D("scale"), N = D("sepia"), P = D("skew"), M = D("space"), U = D("translate"), Q = function() {
  ...
  return {
    ...
    theme: {
      ...
      gradientColorStopPositions: [Ls, Ut],
      inset: R(),
      margin: R(),
      opacity: me(),
      padding: F(),
...
function Ds(e) {
  const t = p(() => e.value.parentElement.parentElement.dataset.accordionId), r = p(() => e.value.parentElement.dataset.panelId), { accordionsStates: o } = pt(), s = p(() => o[t.value]), n = p(() => o[t.value].panels[r.value]), a = p(() => Object.keys(o[t.value].panels[r.value]).length);
  return {
    contentClasses: p(() => E(
      Hs,
...
function Us(e) {
  const t = p(() => e.value.parentElement.parentElement.dataset.accordionId), r = p(() => e.value.parentElement.dataset.panelId), { accordionsStates: o } = pt(), s = p(() => o[t.value]), n = p(() => s.value.panels[r.value]), a = p(() => Object.keys(n.value).length), l = p(() => n.value.order !== a.value - 1), i = p(() => l.value || s.value.flush && n.value.order === a.value - 1 && !n.value.isVisible), d = p(() => E(
    Gs,
...
const qs = { class: "w-full" }, Ks = /* @__PURE__ */ f("path", {
...
}), Js = ["data-panel-id"], Gp = /* @__PURE__ */ C({
  __name: "FwbAccordionPanel",
  setup(e) {
    const { accordionsStates: t } = pt(), r = ho(), o = V(), s = p(() => o.value ? o.value.parentElement.dataset.accordionId : null), n = p(() => t[s.value]);
    return We(() => {
  ...
  Xs,
  en
], rn = "ml-auto -mr-1.5 -my-1.5 rounded-lg focus:ring-2 p-1.5 inline-flex h-8 w-8 dark:bg-gray-800 dark:hover:bg-gray-700", Wp = /* @__PURE__ */ C({
  inheritAttrs: !1,
  __name: "FwbAlert",
  props: {
    type: { default: "info" },
...
}, nn = "ring-2 ring-gray-300 dark:ring-gray-500 p-1", an = "absolute h-3.5 w-3.5 rounded-full border-2 border-white dark:border-gray-800", ln = {
  away: "bg-gray-400",
  busy: "bg-yellow-400",
  offline: "bg-red-400",
  online: "bg-green-400"
...
}, un = "absolute w-auto h-auto text-gray-400", cn = "inline-flex overflow-hidden relative justify-center items-center bg-gray-100 dark:bg-gray-600", pn = "font-medium text-gray-600 dark:text-gray-300", fn = {
  xs: "bottom-0",
  sm: "bottom-0",
  md: "-bottom-1",
  lg: "-bottom-2",
...
const hn = { class: "relative" }, bn = ["alt", "src"], mn = /* @__PURE__ */ f("path", {
  "clip-rule": "evenodd",
  d: "M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z",
  "fill-rule": "evenodd"
}, null, -1), vn = [
  mn
], yn = ["data-pos"], Up = /* @__PURE__ */ C({
  __name: "FwbAvatar",
  props: {
    alt: {
      type: String,
...
const qp = /* @__PURE__ */ ge(wn, [["render", kn]]), _n = ["href"], Kp = /* @__PURE__ */ C({
...
const Yp = /* @__PURE__ */ C({
  ...
  setup(e) {
    const t = e, r = Ue(), o = p(() => !r.default), s = p(() => t.href ? "a" : "span"), { badgeClasses: n } = Fn(t, { isContentEmpty: o });
    return (a, l) => (u(), W(te(s.value), {
      class: w(m(n)),
      href: a.href
    }, {
      default: G(() => [
...
const Jp = /* @__PURE__ */ C({
  ...
  setup(e) {
    const t = e, { breadcrumbClasses: r, breadcrumbWrapperClasses: o } = Bn(J(t));
    return (s, n) => (u(), g("nav", {
      class: w(m(o)),
...
}), On = "ml-1 inline-flex items-center text-sm font-medium dark:text-gray-400", Mn = "text-gray-700 hover:text-gray-900 dark:hover:text-white", Ln = "text-gray-500";
function En(e) {
  return {
    breadcrumbItemClasses: p(() => H(
      On,
      e.href.value ? Mn : Ln
    ))
  };
}
const Nn = { class: "inline-flex items-center" }, Rn = {
  key: 0,
  ...
  viewBox: "0 0 20 20",
  xmlns: "http://www.w3.org/2000/svg"
}, Dn = /* @__PURE__ */ f("path", { d: "M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" }, null, -1), Gn = [
  Dn
], Qp = /* @__PURE__ */ C({
  ...
  setup(e) {
    const t = e, r = p(() => t.href ? "a" : "span"), { breadcrumbItemClasses: o } = En(J(t));
    return (s, n) => (u(), g("li", Nn, [
      v(s.$slots, "arrow-icon", {}, () => [
        e.home ? z("", !0) : (u(), g("svg", Rn, jn))
      ]),
      (u(), W(te(r.value), {
        class: w(m(o)),
        href: e.href
...
function qn(e) {
  const t = p(() => Wn[e.size.value]), r = p(() => Un[e.color.value]), o = p(() => "text-gray-200 dark:text-gray-600"), s = p(() => "animate-spin");
  return { spinnerClasses: p(() => H(
    s.value,
    o.value,
    r.value,
    t.value
...
const Kn = /* @__PURE__ */ f("path", {
  ...
  setup(e) {
    const t = e, { spinnerClasses: r } = qn(J(t));
    return (o, s) => (u(), g("svg", {
      class: w(m(r)),
      fill: "none",
      role: "status",
...
}, Vt = ["blue", "green", "cyan", "teal", "lime", "red", "pink", "purple"], Xn = ["alternative", "light"];
function ea(e) {
  const t = Ue(), r = p(() => e.square.value ? Zn[e.size.value] : Qn[e.size.value]), o = p(() => {
    const n = !!e.gradient.value, a = !!e.color.value, l = e.outline.value;
    let i = "", d = "";
    if (n && l)
      Vt.includes(e.gradient.value) ? console.warn(`cannot use outline prop with "${e.gradient.value}" gradient`) : (d = _r.default[e.gradient.value], e.disabled.value || (i = _r.hover[e.gradient.value]));
    else if (n)
    ...
    let b = "";
    return e.shadow.value === "" ? e.gradient.value && Vt.includes(e.gradient.value) && (b = Cr[e.gradient.value]) : typeof e.shadow.value == "string" && Vt.includes(e.shadow.value) && (b = Cr[e.shadow.value]), [
      d,
      i,
      b,
...
const ra = {
  ...
  setup(e) {
    const t = e, r = ea(J(t)), o = p(() => qt(r.wrapperClasses)), s = p(() => qt(r.spanClasses)), n = p(() => t.outline && t.gradient), a = p(() => t.loading && t.loadingPosition === "prefix"), l = p(() => t.loading && t.loadingPosition === "suffix"), { color: i, size: d } = ta(J(t)), b = t.tag !== "a" ? he(t.tag) : "a", h = t.href ? b : "button", y = t.tag === "router-link" || t.tag === "nuxt-link" ? "to" : "href";
    return (c, x) => (u(), W(te(m(h)), Se({
      class: o.value,
      [m(y) || ""]: c.href,
      disabled: m(h) === "button" && c.disabled
    }), {
      default: G(() => [
        !n.value && (c.$slots.prefix || a.value) ? (u(), g("div", ra, [
          a.value ? (u(), W(ht, {
            key: 0,
            color: m(i),
            size: m(d)
        ...
        f("span", {
          ...
          n.value && (c.$slots.prefix || a.value) ? (u(), g("span", oa, [
            a.value ? (u(), W(ht, {
              key: 0,
              color: m(i),
              size: m(d)
          ...
          v(c.$slots, "default"),
          n.value && (c.$slots.suffix || l.value) ? (u(), g("span", sa, [
            l.value ? (u(), W(ht, {
              key: 0,
              color: m(i),
              size: m(d)
        ...
        !n.value && (c.$slots.suffix || l.value) ? (u(), g("div", na, [
          l.value ? (u(), W(ht, {
            key: 0,
            color: m(i),
            size: m(d)
...
const Zp = /* @__PURE__ */ ge(la, [["render", da]]);
function ua(e) {
...
const ca = ["alt", "src"], Xp = /* @__PURE__ */ C({
  __name: "FwbCard",
  props: {
    href: {
      type: String,
  ...
  setup(e) {
    const t = e, { cardClasses: r, horizontalImageClasses: o } = ua(J(t)), s = p(() => t.href ? "a" : "div");
    return (n, a) => (u(), W(te(s.value), {
      class: w(m(r)),
      href: e.href
    }, {
      default: G(() => [
  ...
  va
], wa = ["onClick"], xa = /* @__PURE__ */ f("span", { class: "inline-flex justify-center items-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none" }, [
  /* @__PURE__ */ f("svg", {
    class: "w-5 h-5 text-white sm:w-6 sm:h-6 dark:text-gray-800",
    fill: "none",
    stroke: "currentColor",
  ...
  setup(e) {
    ...
    return We(() => {
      ...
      f("div", fa, [
        (u(!0), g(Y, null, Me(e.pictures, (y, c) => (u(), g("div", {
          key: c,
      ...
      e.noIndicators ? z("", !0) : (u(), g("div", ha, [
        (u(!0), g(Y, null, Me(e.pictures, (y, c) => (u(), g("button", {
          key: c,
          "aria-label": "Slide " + c,
          class: w([c === r.value ? "bg-white" : "bg-white/50", "w-3 h-3 rounded-full bg-white"]),
          "aria-current": "false",
          type: "button",
          onClick: wt((x) => l(c), ["prevent"])
        }, null, 10, ba))), 128))
      ])),
...
var $r;
const rr = typeof window < "u", _a = (e) => typeof e < "u", Ca = (e) => typeof e == "function", $a = (e) => typeof e == "string", jt = () => {
};
...
function Ia(e = !1, t = {}) {
  ...
  function a(l) {
    ...
    {
      const i = Ct(r);
      return n.value = n.value === i ? Ct(o) : i, n.value;
    }
  }
  return s ? a : [n, a];
}
...
const It = rr ? window : void 0;
function bt(...e) {
  let t, r, o, s;
  if ($a(e[0]) ? ([r, o, s] = e, t = It) : [t, r, o, s] = e, !t)
    return jt;
  let n = jt;
  const a = _t(() => tt(t), (i) => {
    n(), i && (i.addEventListener(r, o, s), n = () => {
      i.removeEventListener(r, o, s), n = jt;
    });
...
function Aa(e, t, r = {}) {
  const { window: o = It, ignore: s, capture: n = !0, detectIframe: a = !1 } = r;
  if (!o)
    return;
  const l = V(!0);
  let i;
  const d = (c) => {
    ...
    bt(o, "click", d, { passive: !0, capture: n }),
    bt(o, "pointerdown", (c) => {
      const x = tt(e);
...
function Xe(e, t = {}) {
  const { window: r = It } = t, o = Ba(() => r && "matchMedia" in r && typeof r.matchMedia == "function");
  let s;
  const n = V(!1), a = () => {
    s && ("removeEventListener" in s ? s.removeEventListener("change", l) : s.removeListener(l));
  }, l = () => {
    o.value && (a(), s = r.matchMedia(Pa(e).value), n.value = s.matches, "addEventListener" in s ? s.addEventListener("change", l) : s.addListener(l));
  };
  return as(l), or(() => a()), n;
}
const ko = {
...
var Oa = Object.defineProperty, Sr = Object.getOwnPropertySymbols, Ma = Object.prototype.hasOwnProperty, La = Object.prototype.propertyIsEnumerable, Tr = (e, t, r) => t in e ? Oa(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, Ea = (e, t) => {
  for (var r in t || (t = {}))
    Ma.call(t, r) && Tr(e, r, t[r]);
  if (Sr)
    for (var r of Sr(t))
...
function _o(e, t = {}) {
  function r(l, i) {
    let d = e[l];
    return i != null && (d = Ta(d, i)), typeof d == "number" && (d = `${d}px`), d;
  }
  const { window: o = It } = t;
  function s(l) {
    return o ? o.matchMedia(l).matches : !1;
  }
  const n = (l) => Xe(`(min-width: ${r(l)})`, t), a = Object.keys(e).reduce((l, i) => (Object.defineProperty(l, i, {
    get: () => n(i),
    enumerable: !0,
    configurable: !0
  }), l), {});
  return Ea({
    greater(l) {
      return Xe(`(min-width: ${r(l, 0.1)})`, t);
    },
    greaterOrEqual: n,
    smaller(l) {
      return Xe(`(max-width: ${r(l, -0.1)})`, t);
    },
    smallerOrEqual(l) {
      return Xe(`(max-width: ${r(l)})`, t);
    },
    between(l, i) {
      return Xe(`(min-width: ${r(l)}) and (max-width: ${r(i, -0.1)})`, t);
    },
    isGreater(l) {
...
var Ra = Object.defineProperty, Ir = Object.getOwnPropertySymbols, Va = Object.prototype.hasOwnProperty, ja = Object.prototype.propertyIsEnumerable, Ar = (e, t, r) => t in e ? Ra(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, Ha = (e, t) => {
  for (var r in t || (t = {}))
    Va.call(t, r) && Ar(e, r, t[r]);
  if (Ir)
    for (var r of Ir(t))
...
function Co(e, t, r, o = {}) {
  ...
  const k = (T) => l ? Ca(l) ? l(T) : Na(T) : T, $ = () => _a(e[t]) ? k(e[t]) : h;
  if (i) {
    const T = $(), S = V(T);
    return _t(() => e[t], (I) => S.value = k(I)), _t(S, (I) => {
      (I !== e[t] || b) && c(x, I);
    }, { deep: b }), S;
  } else
    return p({
...
const Wa = Ga;
var Ua = typeof self == "object" && self && self.Object === Object && self, qa = Wa || Ua || Function("return this")();
const sr = qa;
var Ka = sr.Symbol;
const Ce = Ka;
var $o = Object.prototype, Ya = $o.hasOwnProperty, Ja = $o.toString, et = Ce ? Ce.toStringTag : void 0;
function Qa(e) {
  var t = Ya.call(e, et), r = e[et];
  try {
    e[et] = void 0;
    var o = !0;
  } catch {
...
var Za = Object.prototype, Xa = Za.toString;
function el(e) {
  return Xa.call(e);
}
var tl = "[object Null]", rl = "[object Undefined]", Br = Ce ? Ce.toStringTag : void 0;
function nr(e) {
  return e == null ? e === void 0 ? rl : tl : Br && Br in Object(e) ? Qa(e) : el(e);
}
function ar(e) {
...
const qe = nl;
var al = 1 / 0, Or = Ce ? Ce.prototype : void 0, Mr = Or ? Or.toString : void 0;
function So(e) {
  if (typeof e == "string")
    return e;
  if (qe(e))
...
var il = "[object AsyncFunction]", dl = "[object Function]", ul = "[object GeneratorFunction]", cl = "[object Proxy]";
function pl(e) {
  if (!$t(e))
    return !1;
  var t = nr(e);
  return t == dl || t == ul || t == il || t == cl;
}
var fl = sr["__core-js_shared__"];
const Ht = fl;
var Lr = function() {
...
var hl = Function.prototype, bl = hl.toString;
function ml(e) {
  if (e != null) {
    try {
      return bl.call(e);
...
var vl = /[\\^$.*+?()[\]{}|]/g, yl = /^\[object .+?Constructor\]$/, wl = Function.prototype, xl = Object.prototype, kl = wl.toString, _l = xl.hasOwnProperty, Cl = RegExp(
  "^" + kl.call(_l).replace(vl, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function $l(e) {
  if (!$t(e) || gl(e))
    return !1;
...
var Ll = Il(Ml);
const El = Ll;
var Nl = 9007199254740991, Rl = /^(?:0|[1-9]\d*)$/;
function To(e, t) {
  var r = typeof e;
  return t = t ?? Nl, !!t && (r == "number" || r != "symbol" && Rl.test(e)) && e > -1 && e % 1 == 0 && e < t;
}
function Vl(e, t, r) {
...
function Dl(e, t, r) {
  var o = e[t];
  (!(Hl.call(e, t) && Po(o, r)) || r === void 0 && !(t in e)) && Vl(e, t, r);
}
var Er = Math.max;
function Gl(e, t, r) {
...
var zo = Object.prototype, Kl = zo.hasOwnProperty, Yl = zo.propertyIsEnumerable, Jl = Nr(function() {
  return arguments;
}()) ? Nr : function(e) {
...
function Xl(e, t) {
  if (qe(e))
    return !1;
  var r = typeof e;
  return r == "number" || r == "symbol" || r == "boolean" || e == null || lr(e) ? !0 : Zl.test(e) || !Ql.test(e) || t != null && e in Object(t);
}
var ei = ir(Object, "create");
const it = ei;
function ti() {
...
var oi = "__lodash_hash_undefined__", si = Object.prototype, ni = si.hasOwnProperty;
function ai(e) {
  var t = this.__data__;
  if (it) {
    var r = t[e];
...
var li = Object.prototype, ii = li.hasOwnProperty;
function di(e) {
  var t = this.__data__;
  return it ? t[e] !== void 0 : ii.call(t, e);
}
var ui = "__lodash_hash_undefined__";
function ci(e, t) {
  var r = this.__data__;
  return this.size += this.has(e) ? 0 : 1, r[e] = it && t === void 0 ? ui : t, this;
}
function Le(e) {
...
Le.prototype.clear = ti;
Le.prototype.delete = ri;
Le.prototype.get = ai;
Le.prototype.has = di;
Le.prototype.set = ci;
function pi() {
...
var fi = Array.prototype, gi = fi.splice;
function hi(e) {
...
Ke.prototype.clear = pi;
Ke.prototype.delete = hi;
Ke.prototype.get = bi;
Ke.prototype.has = mi;
Ke.prototype.set = vi;
var yi = ir(sr, "Map");
...
function dr(e, t) {
  ...
  return r.cache = new (dr.Cache || Ne)(), r;
}
dr.Cache = Ne;
var Pi = 500;
function zi(e) {
...
var Fi = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, Ii = /\\(\\)?/g, Ai = zi(function(e) {
  var t = [];
  return e.charCodeAt(0) === 46 && t.push(""), e.replace(Fi, function(r, o, s, n) {
    t.push(s ? n.replace(Ii, "$1") : o || r);
  }), t;
});
const Bi = Ai;
function Oi(e) {
...
function Ot(e, t) {
  return qe(e) ? e : Xl(e, t) ? [e] : Bi(Oi(e));
}
var Mi = 1 / 0;
function ur(e) {
...
var Rr = Ce ? Ce.isConcatSpreadable : void 0;
function Ni(e) {
  return qe(e) || Fo(e) || !!(Rr && e && e[Rr]);
}
function Io(e, t, r, o, s) {
  var n = -1, a = e.length;
  for (r || (r = Ni), s || (s = []); ++n < a; ) {
    var l = e[n];
    t > 0 && r(l) ? t > 1 ? Io(l, t - 1, r, o, s) : Ei(s, l) : o || (s[s.length] = l);
  }
  return s;
}
function Ri(e) {
...
function Hi(e, t, r) {
  ...
  return n || ++o != s ? n : (s = e == null ? 0 : e.length, !!s && Ul(s) && To(a, s) && (qe(e) || Fo(e)));
}
function Di(e, t) {
...
function Gi(e, t, r, o) {
  ...
  for (var s = -1, n = t.length, a = n - 1, l = e; l != null && ++s < n; ) {
    ...
    if (s != a) {
      var b = l[i];
      d = o ? o(b, i, l) : void 0, d === void 0 && (d = $t(b) ? b : To(t[s + 1]) ? [] : {});
    }
    Dl(l, i, d), l = l[i];
  }
  return e;
...
function Ui(e, t) {
  return Wi(e, t, function(r, o) {
    return Di(e, o);
  });
}
var qi = Vi(function(e, t) {
...
const Vr = C({
...
}), Zi = "absolute z-10 bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700", mt = 8, Xi = {
  bottom: "",
  left: "top-0",
  right: "top-0",
  top: ""
  ...
  bottom(e) {
    return `bottom: -${e.height + mt}px;`;
  },
  left(e) {
    return `left: -${e.width + mt}px;`;
  },
  right(e) {
    return `right: -${e.width + mt}px;`;
  },
  top(e) {
    return `top: -${e.height + mt}px;`;
  }
};
function td(e) {
  _t(e.visible, (s) => {
  ...
  const t = V(""), r = () => {
    ...
    t.value = ed[e.placement.value](s);
  };
  return {
    contentClasses: p(() => H(
      Zi,
      Xi[e.placement.value]
    )),
    contentStyles: t
  };
}
const rd = (e) => (io("data-v-7ea3917f"), e = e(), uo(), e), od = { class: "inline-flex items-center" }, sd = /* @__PURE__ */ rd(() => /* @__PURE__ */ f("svg", {
  class: "w-4 h-4 ml-2",
  fill: "none",
  stroke: "currentColor",
  viewBox: "0 0 24 24",
  ...
  setup(e) {
    const t = e, r = V(!1), o = () => r.value = !1, s = () => r.value = !r.value, n = {
      ...
      right: "to-right",
      top: "to-top"
    }, a = p(() => t.transition === null ? n[t.placement] : t.transition), l = V(), i = V(), { contentClasses: d, contentStyles: b } = td({
...
const tf = /* @__PURE__ */ ge(nd, [["__scopeId", "data-v-7ea3917f"]]), rf = /* @__PURE__ */ C({
  inheritAttrs: !1,
  __name: "FwbFooter",
  props: {
...
}), ad = ["href"], ld = ["alt", "src"], of = /* @__PURE__ */ C({
  inheritAttrs: !1,
...
}), id = { class: "sr-only" }, nf = /* @__PURE__ */ C({
  inheritAttrs: !1,
...
}), dd = "overflow-hidden w-48 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white";
function ud() {
  return {
    containerClasses: p(() => H(
      dd
    ))
  };
}
...
function se(...e) {
  return e.filter((t) => t).reduce((t, r) => {
    const o = Array.isArray(r) ? Array.from(r).map((b) => b.split(" ")).flat() : r.split(" "), s = o.map((b) => pd(b)), n = s.filter((b) => !t.types.includes(b)), l = [...s.filter((b) => t.types.includes(b)), ...n], i = [.../* @__PURE__ */ new Set([...t.types, ...l])], d = i.map((b) => {
      if (l.includes(b)) {
        const y = s.indexOf(b);
        if (y >= 0)
          return o[y] || "";
...
const fd = "inline-flex items-center w-full px-4 py-2 border-b border-gray-200 dark:border-gray-600", gd = "block w-full px-4 py-2 cursor-pointer hover:bg-gray-100 hover:text-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:hover:bg-gray-600 dark:hover:text-white dark:focus:ring-gray-500 dark:focus:text-white", hd = "bg-gray-100 cursor-not-allowed dark:bg-gray-600 dark:text-gray-400";
function bd(e) {
  return {
    itemClasses: p(() => se(
      fd,
      e.disabled.value ? hd : "",
      !e.disabled.value && e.hover.value ? gd : ""
    ))
  };
}
const md = {
  ...
  setup(e) {
    const t = e, { itemClasses: r } = bd(J(t));
    return (o, s) => (u(), g("li", {
      class: w(m(r))
    }, [
      o.$slots.prefix ? (u(), g("div", md, [
        v(o.$slots, "prefix")
      ])) : z("", !0),
      v(o.$slots, "default"),
      o.$slots.suffix ? (u(), g("div", vd, [
        v(o.$slots, "suffix")
      ])) : z("", !0)
    ], 2));
  }
}), yd = /* @__PURE__ */ f("div", { class: "bg-gray-900 bg-opacity-50 dark:bg-opacity-80 fixed inset-0 z-40" }, null, -1), wd = ["onClick", "onKeyup"], xd = { class: "relative bg-white rounded-lg shadow dark:bg-gray-700" }, kd = /* @__PURE__ */ f("svg", {
  class: "w-5 h-5",
  fill: "currentColor",
  viewBox: "0 0 20 20",
  xmlns: "http://www.w3.org/2000/svg"
...
}), Cd = { class: "container flex flex-wrap justify-between items-center mx-auto" }, $d = /* @__PURE__ */ f("span", { class: "sr-only" }, "Open main menu", -1), Sd = /* @__PURE__ */ f("svg", {
  "aria-hidden": "true",
  class: "w-6 h-6",
  fill: "currentColor",
  viewBox: "0 0 20 20",
...
}, Pd = " border-gray-200", zd = "fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600", Fd = "rounded", Id = "p-3 bg-gray-50 dark:bg-gray-800 dark:border-gray-700", Ad = "bg-white px-2 sm:px-4 py-2.5 dark:bg-gray-900", pf = /* @__PURE__ */ C({
  __name: "FwbNavbar",
  props: {
    class: {
      type: String,
  ...
  setup(e) {
    const t = e, r = Ue(), s = _o(ko).smaller("md"), n = V(!1), a = Ia(n), l = p(() => qt(
      [
        Pd,
        t.sticky ? zd : "",
        t.rounded ? Fd : "",
    ...
    return (d, b) => (u(), g("nav", {
      ...
      f("div", Cd, [
        ...
        m(r)["right-side"] ? (u(), g("div", Td, [
          v(d.$slots, "right-side")
        ])) : z("", !0)
      ])
    ], 2));
  }
}), Bd = "w-full md:block md:w-auto", Od = "flex flex-col p-4 mt-4 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700", Md = "bg-gray-50", ff = /* @__PURE__ */ C({
  ...
  setup(e) {
    const t = e, o = _o(ko).smaller("md"), s = p(() => H(
      Bd,
      t.isShowMenu ? "" : "hidden"
    )), n = p(() => H(
      Od,
...
}), Rd = ["src", "alt"], Vd = { class: "self-center text-xl font-semibold whitespace-nowrap dark:text-white" }, hf = /* @__PURE__ */ C({
...
}), jd = { "aria-label": "Navigation" }, Hd = { class: "font-semibold text-gray-900 dark:text-white" }, Dd = { class: "font-semibold text-gray-900 dark:text-white" }, Gd = { class: "font-semibold text-gray-900 dark:text-white" }, Wd = ["disabled"], Ud = ["disabled"], qd = {
  key: 0,
  stroke: "currentColor",
  fill: "currentColor",
  "stroke-width": "0",
  ...
  Kd
], Jd = ["disabled", "onClick"], Qd = ["disabled"], Zd = {
  key: 0,
  stroke: "currentColor",
  fill: "currentColor",
  "stroke-width": "0",
      ...
      f("div", {
        ...
        v(_.$slots, "prev-button", {
          ...
          f("button", {
            ...
            v(_.$slots, "prev-icon", {}, () => [
              _.showIcons || _.$slots["prev-icon"] ? (u(), g("svg", qd, Yd)) : z("", !0)
            ]),
        ...
        (u(!0), g(Y, null, Me(y.value, (P) => v(_.$slots, "page-button", {
          key: P,
          page: P,
          setPage: o,
          disabled: h(P)
        ...
        v(_.$slots, "next-button", {
          ...
          f("button", {
            ...
            v(_.$slots, "next-icon", {}, () => [
              _.showIcons || _.$slots["next-icon"] ? (u(), g("svg", Zd, eu)) : z("", !0)
            ])
          ], 10, Qd)
        ]),
...
const nu = {
  ...
  setup(e) {
    ...
    return (n, a) => (u(), g("div", null, [
      n.label || n.labelProgress && n.labelPosition === "outside" ? (u(), g("div", nu, [
        f("span", {
...
function lu(e) {
  return { sizeClasses: p(() => H(
    au[e.size.value] ?? ""
  )) };
}
const iu = { class: "flex items-center" }, du = /* @__PURE__ */ f("path", { d: "M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" }, null, -1), uu = [
  du
], cu = /* @__PURE__ */ f("path", { d: "M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" }, null, -1), pu = [
  cu
], fu = /* @__PURE__ */ f("span", { class: "w-1 h-1 mx-1.5 bg-gray-500 rounded-full dark:bg-gray-400" }, null, -1), gu = ["href"], vf = /* @__PURE__ */ C({
  __name: "FwbRating",
  props: {
    rating: { default: 3 },
    reviewLink: { default: "" },
  ...
  setup(e) {
    const t = e, r = p(() => Math.floor(t.rating)), o = p(() => t.scale - r.value), { sizeClasses: s } = lu(J(t));
    return (n, a) => (u(), g("div", iu, [
      (u(!0), g(Y, null, Me(r.value, (l) => (u(), g("svg", {
        key: l,
      ...
      (u(!0), g(Y, null, Me(o.value, (l) => (u(), g("svg", {
        key: l,
...
}), hu = { class: "h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800" }, bu = { class: "space-y-2 font-medium" }, yf = /* @__PURE__ */ C({
  inheritAttrs: !1,
  __name: "FwbSidebar",
  setup(e) {
  ...
  role: "alert"
}, vu = { class: "flex items-center mb-3" }, yu = { class: "bg-orange-100 text-orange-800 text-sm font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-orange-200 dark:text-orange-900" }, wu = /* @__PURE__ */ f("span", { class: "sr-only" }, "Close", -1), xu = /* @__PURE__ */ f("svg", {
  class: "w-2.5 h-2.5",
  "aria-hidden": "true",
  xmlns: "http://www.w3.org/2000/svg",
  fill: "none",
  ...
  setup(e, { emit: t }) {
    ...
    return (o, s) => (u(), g("div", mu, [
      f("div", vu, [
        f("span", yu, O(o.label), 1),
        f("button", {
          type: "button",
...
}), _u = { class: "overflow-hidden" }, Cu = /* @__PURE__ */ f("svg", {
...
], -1), $u = { class: "flex-1 ml-3 text-left whitespace-nowrap" }, Su = /* @__PURE__ */ f("path", {
  stroke: "currentColor",
  "stroke-linecap": "round",
  "stroke-linejoin": "round",
  "stroke-width": "2",
  ...
  Su
], Pu = { class: "py-2 space-y-2 z-0 overflow-hidden" }, zu = { key: 0 }, xf = /* @__PURE__ */ C({
...
}), Fu = "pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700", _f = /* @__PURE__ */ C({
...
}), Iu = ["src", "alt"], Au = { class: "self-center text-xl font-semibold whitespace-nowrap dark:text-white" }, Cf = /* @__PURE__ */ C({
  ...
  setup(e) {
    ...
    return (s, n) => (u(), W(te(m(r)), Se({
      ...
      default: G(() => [
        ...
        f("span", Au, O(s.name), 1)
      ]),
      _: 1
    }, 16));
  }
}), Bu = { class: "relative overflow-x-auto shadow-md sm:rounded-lg" }, Ou = { class: "w-full text-sm text-left text-gray-500 dark:text-gray-400" }, $f = /* @__PURE__ */ C({
  __name: "FwbTable",
  props: {
    striped: {
      type: Boolean,
  ...
  setup(e) {
    const t = e;
    return ue("hoverable", t.hoverable), ue("striped", t.striped), ue("stripedColumns", t.stripedColumns), (r, o) => (u(), g("div", Bu, [
      f("table", Ou, [
        v(r.$slots, "default")
      ])
    ]));
...
const Sf = /* @__PURE__ */ ge(Mu, [["render", Lu]]), Eu = "px-6 py-4 first:font-medium first:text-gray-900 first:dark:text-white first:whitespace-nowrap last:text-right", Nu = "even:bg-gray-white even:dark:bg-gray-900 odd:dark:bg-gray-800 odd:bg-gray-50";
function Ru() {
  const e = ee("stripedColumns");
  return { tableCellClasses: p(() => H(
    Eu,
    { [Nu]: e }
  )) };
}
...
}), Vu = {}, ju = { class: "text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400" };
function Hu(e, t) {
  return u(), g("thead", ju, [
    f("tr", null, [
      v(e.$slots, "default")
...
const Pf = /* @__PURE__ */ ge(Vu, [["render", Hu]]), Du = "px-6 py-3 text-xs uppercase", Gu = "even:bg-white even:dark:bg-gray-900 odd:dark:bg-gray-800 odd:bg-gray-50";
function Wu() {
  const e = ee("stripedColumns");
  return { tableHeadCellClasses: p(() => H(
    Du,
    { [Gu]: e }
  )) };
}
const zf = /* @__PURE__ */ C({
  ...
  setup(e) {
    const { tableHeadCellClasses: t } = Wu();
    return (r, o) => (u(), g("th", {
      scope: "col",
      class: w(m(t))
    }, [
...
}), Uu = "bg-white dark:bg-gray-800 [&:not(:last-child)]:border-b [&:not(:last-child)]:dark:border-gray-700", qu = "odd:bg-white even:bg-gray-50 odd:dark:bg-gray-800 even:dark:bg-gray-700", Ku = "hover:bg-gray-50 dark:hover:bg-gray-600";
function Yu() {
  const e = ee("striped"), t = ee("hoverable");
  return { tableRowClasses: p(() => H(
    Uu,
    {
      [Ku]: t,
      [qu]: e
...
const Ff = /* @__PURE__ */ C({
...
}), Ao = "flowbite-tab-activate-func-injection", Bo = "flowbite-tab-active-name-injection", Oo = "flowbite-tab-style-injection", Mo = "flowbite-tab-visibility-directive-injection", Ju = { key: 0 }, Qu = { key: 1 }, If = /* @__PURE__ */ C({
  __FLOWBITE_TAB__: !0,
  __name: "FwbTab",
  props: {
    name: {
  ...
  setup(e) {
    ...
    return (o, s) => m(r) === "if" ? (u(), g(Y, { key: 0 }, [
      m(t) === e.name ? (u(), g("div", Ju, [
        v(o.$slots, "default")
      ])) : z("", !0)
    ], 64)) : m(r) === "show" ? Te((u(), g("div", Qu, [
      v(o.$slots, "default")
    ], 512)), [
      [is, m(t) === e.name]
    ]) : z("", !0);
...
const Lo = "flowbite-themable-injection-key", je = {
  blue: {
...
function Eo(e) {
  const t = ee(Lo, V(null)), r = p(() => e || t.value), o = p(() => !!t?.value), s = p(
    () => r.value ? je[r.value].background : ""
  ), n = p(
    () => r.value ? je[r.value].border : ""
  ), a = p(() => t?.value || void 0), l = p(
    () => r.value ? je[r.value].disabled : ""
  ), i = p(
    () => r.value ? je[r.value].focus : ""
  ), d = p(
    () => r.value ? je[r.value].hover : ""
  ), b = p(
    () => r.value ? je[r.value].text : ""
  );
  return {
    backgroundClasses: s,
    borderClasses: n,
...
const oc = /* @__PURE__ */ C({
  ...
  setup(e, { emit: t }) {
    const r = e, { ulClasses: o, divClasses: s } = Zu(r);
    ue(Oo, r.variant);
    const a = Ue().default, l = p(() => a ? Tt(a()).filter((h) => h.type.__FLOWBITE_TAB__) : []), i = p({
      get: () => r.modelValue,
      set: (h) => t("update:modelValue", h)
    });
    ue(Bo, i), ue(Mo, lt(r, "directive"));
    const d = (h) => {
      i.value = h;
    }, b = () => {
      t("click:pane");
    ...
    return ue(Ao, d), (h, y) => (u(), g(Y, null, [
      f("div", {
        ...
        f("ul", {
          ...
          (u(!0), g(Y, null, Me(l.value, (c, x) => (u(), W(oc, {
            key: x,
...
}), sc = "relative border-gray-200 dark:border-gray-700", nc = "border-l", ac = "flex", Bf = /* @__PURE__ */ C({
  __name: "FwbTimeline",
  props: {
    horizontal: {
      type: Boolean,
...
}), lc = {}, ic = { class: "font-normal mb-4 text-base text-gray-500 dark:text-gray-400" };
function dc(e, t) {
  return u(), g("p", ic, [
    v(e.$slots, "default")
  ]);
}
const Of = /* @__PURE__ */ ge(lc, [["render", dc]]), Mf = /* @__PURE__ */ C({
  __name: "FwbTimelineContent",
  setup(e) {
    const t = ee("horizontal"), r = p(() => H(t ? "mt-3 sm:pr-8" : ""));
    return (o, s) => (u(), g("div", {
      class: w(r.value)
    }, [
      v(o.$slots, "default")
...
}), uc = "mb-10", cc = "mb-6 sm:mb-0 relative", pc = "ml-6", Lf = /* @__PURE__ */ C({
  __name: "FwbTimelineItem",
  setup(e) {
    const t = ee("horizontal"), r = p(() => H(uc, t ? cc : pc));
    return (o, s) => (u(), g("li", {
      class: w(r.value)
    }, [
      v(o.$slots, "default")
...
}), fc = "h-0.5 w-full bg-gray-200 dark:bg-gray-700 sm:flex", Ef = /* @__PURE__ */ C({
  __name: "FwbTimelinePoint",
  setup(e) {
    const t = Ue(), r = p(() => !!t.default), o = ee("horizontal"), s = p(() => H(o ? "flex items-center" : "")), n = p(() => H(fc, { "sm:hidden hidden": !o })), a = p(() => {
...
}), gc = {}, hc = { class: "font-normal leading-none mb-1 text-gray-400 dark:text-gray-500 text-sm" };
function bc(e, t) {
  return u(), g("time", hc, [
    v(e.$slots, "default")
  ]);
}
const Nf = /* @__PURE__ */ ge(gc, [["render", bc]]), mc = {}, vc = { class: "font-semibold text-gray-900 dark:text-white text-lg" };
function yc(e, t) {
  return u(), g("h3", vc, [
    v(e.$slots, "default")
  ]);
}
const Rf = /* @__PURE__ */ ge(mc, [["render", yc]]), wc = {
...
function kc(e) {
  const t = p(() => wc[e.type.value]), r = p(() => {
    const s = xc[e.alignment.value];
...
const Cc = /* @__PURE__ */ C({
  ...
  setup(e) {
    const t = e, r = de(), { classes: o } = _c(J(t)), s = p(() => r.class || "");
    return (n, a) => (u(), W(te(e.tag), {
  ...
  Ac
], Oc = /* @__PURE__ */ f("span", { class: "sr-only" }, "Close", -1), Mc = /* @__PURE__ */ f("svg", {
  class: "w-5 h-5",
  fill: "currentColor",
  viewBox: "0 0 20 20",
  xmlns: "http://www.w3.org/2000/svg"
  ...
  setup(e, { emit: t }) {
    ...
    return (i, d) => o.value ? (u(), g("div", {
      ...
      e.type !== "empty" || i.$slots.icon ? (u(), W(Cc, {
        key: 0,
        ...
        default: G(() => [
          ...
          }) : e.type === "success" ? (u(), g("svg", $c, Tc)) : e.type === "danger" ? (u(), g("svg", Pc, Fc)) : e.type === "warning" ? (u(), g("svg", Ic, Bc)) : z("", !0)
        ]),
        _: 3
      }, 8, ["class"])) : z("", !0),
      f("div", {
...
}), No = "flowbite-toast-injection-key", Ec = C({
  components: {
    FwbToast: Gr
  },
  props: {
...
const Vf = /* @__PURE__ */ ge(Ec, [["__scopeId", "data-v-aba06225"]]);
function le(e) {
  return e.split("-")[1];
}
function cr(e) {
...
function Wr(e, t, r) {
  ...
  const n = o.x + o.width / 2 - s.width / 2, a = o.y + o.height / 2 - s.height / 2, l = Ye(t), i = cr(l), d = o[i] / 2 - s[i] / 2, b = l === "x";
  let h;
  switch (ce(t)) {
    case "top":
...
const dt = Math.min, Ie = Math.max;
function Kt(e, t, r) {
  return Ie(e, dt(t, r));
}
const Rc = (e) => ({ name: "arrow", options: e, async fn(t) {
  const { x: r, y: o, placement: s, rects: n, platform: a, elements: l } = t, { element: i, padding: d = 0 } = Re(e, t) || {};
  if (i == null)
    return {};
  const b = Ro(d), h = { x: r, y: o }, y = Ye(s), c = cr(y), x = await a.getDimensions(i), k = y === "y", $ = k ? "top" : "left", T = k ? "bottom" : "right", S = k ? "clientHeight" : "clientWidth", I = n.reference[c] + n.reference[y] - h[y] - n.floating[c], _ = h[y] - n.reference[y], N = await (a.getOffsetParent == null ? void 0 : a.getOffsetParent(i));
  let P = N ? N[S] : 0;
  P && await (a.isElement == null ? void 0 : a.isElement(N)) || (P = l.floating[S] || n.floating[c]);
  const M = I / 2 - _ / 2, U = P / 2 - x[c] / 2 - 1, Q = dt(b[$], U), j = dt(b[T], U), R = Q, F = P - x[c] - j, L = P / 2 - x[c] / 2 + M, q = Kt(R, L, F), Z = le(s) != null && L != q && n.reference[c] / 2 - (L < R ? Q : j) - x[c] / 2 < 0 ? L < R ? R - L : F - L : 0;
  return { [y]: h[y] - Z, data: { [y]: q, centerOffset: L - q + Z } };
} }), Vc = ["top", "right", "bottom", "left"], Ur = Vc.reduce((e, t) => e.concat(t, t + "-start", t + "-end"), []), jc = { left: "right", right: "left", bottom: "top", top: "bottom" };
function Pt(e) {
  return e.replace(/left|right|bottom|top/g, (t) => jc[t]);
}
function Vo(e, t, r) {
  r === void 0 && (r = !1);
  const o = le(e), s = Ye(e), n = cr(s);
  let a = s === "x" ? o === (r ? "end" : "start") ? "right" : "left" : o === "start" ? "bottom" : "top";
  return t.reference[n] > t.floating[n] && (a = Pt(a)), { main: a, cross: Pt(a) };
}
const Hc = { start: "end", end: "start" };
function xt(e) {
...
const Dc = function(e) {
  return e === void 0 && (e = {}), { name: "autoPlacement", options: e, async fn(t) {
    var r, o, s;
    const { rects: n, middlewareData: a, placement: l, platform: i, elements: d } = t, { crossAxis: b = !1, alignment: h, allowedPlacements: y = Ur, autoAlignment: c = !0, ...x } = Re(e, t), k = h !== void 0 || y === Ur ? function(j, R, F) {
      return (j ? [...F.filter((L) => le(L) === j), ...F.filter((L) => le(L) !== j)] : F.filter((L) => ce(L) === L)).filter((L) => !j || le(L) === j || !!R && xt(L) !== L);
    }(h || null, c, y) : y, $ = await Mt(t, x), T = ((r = a.autoPlacement) == null ? void 0 : r.index) || 0, S = k[T];
    if (S == null)
      return {};
  ...
  return e === void 0 && (e = {}), { name: "flip", options: e, async fn(t) {
    var r;
    const { placement: o, middlewareData: s, rects: n, initialPlacement: a, platform: l, elements: i } = t, { mainAxis: d = !0, crossAxis: b = !0, fallbackPlacements: h, fallbackStrategy: y = "bestFit", fallbackAxisSideDirection: c = "none", flipAlignment: x = !0, ...k } = Re(e, t), $ = ce(o), T = ce(a) === a, S = await (l.isRTL == null ? void 0 : l.isRTL(i.floating)), I = h || (T || !x ? [Pt(a)] : function(R) {
      const F = Pt(R);
      return [xt(R), F, xt(F)];
    }(a));
    h || c === "none" || I.push(...function(R, F, L, q) {
      const Z = le(R);
      let K = function(be, Pe, ze) {
        const Je = ["left", "right"], me = ["right", "left"], Ve = ["top", "bottom"], X = ["bottom", "top"];
        switch (be) {
          case "top":
          case "bottom":
            return ze ? Pe ? me : Je : Pe ? Je : me;
          case "left":
          case "right":
            return Pe ? Ve : X;
          default:
      ...
      return Z && (K = K.map((be) => be + "-" + Z), F && (K = K.concat(K.map(xt)))), K;
    }(a, x, c, S));
    const _ = [a, ...I], N = await Mt(t, k), P = [];
  ...
  return e === void 0 && (e = 0), { name: "offset", options: e, async fn(t) {
    const { x: r, y: o } = t, s = await async function(n, a) {
      const { placement: l, platform: i, elements: d } = n, b = await (i.isRTL == null ? void 0 : i.isRTL(d.floating)), h = ce(l), y = le(l), c = Ye(l) === "x", x = ["left", "top"].includes(h) ? -1 : 1, k = b && c ? -1 : 1, $ = Re(a, n);
...
const qc = function(e) {
  return e === void 0 && (e = {}), { name: "shift", options: e, async fn(t) {
    const { x: r, y: o, placement: s } = t, { mainAxis: n = !0, crossAxis: a = !1, limiter: l = { fn: ($) => {
      let { x: T, y: S } = $;
      return { x: T, y: S };
    } }, ...i } = Re(e, t), d = { x: r, y: o }, b = await Mt(t, i), h = Ye(ce(s)), y = Uc(h);
    let c = d[h], x = d[y];
    if (n) {
  ...
  return e === void 0 && (e = {}), { name: "size", options: e, async fn(t) {
    ...
    }, ...l } = Re(e, t), i = await Mt(t, l), d = ce(r), b = le(r), h = Ye(r) === "x", { width: y, height: c } = o.floating;
    let x, k;
    ...
    if (S && !b) {
      const P = Ie(i.left, 0), M = Ie(i.right, 0), U = Ie(i.top, 0), Q = Ie(i.bottom, 0);
      h ? _ = y - 2 * (P !== 0 || M !== 0 ? P + M : Ie(i.left, i.right)) : I = c - 2 * (U !== 0 || Q !== 0 ? U + Q : Ie(i.top, i.bottom));
    }
...
const qr = Math.min, st = Math.max, zt = Math.round;
function jo(e) {
  const t = pe(e);
...
function ut(e, t, r, o) {
  ...
  if (l) {
    ...
    for (; T && o && $ !== k; ) {
      const S = De(T), I = T.getBoundingClientRect(), _ = getComputedStyle(T);
...
function qo(e) {
  return ut(_e(e)).left + Et(e).scrollLeft;
}
function ct(e) {
  if ($e(e) === "html")
    return e;
...
function Ko(e) {
  const t = ct(e);
  return pr(t) ? t.ownerDocument.body : fe(t) && Lt(t) ? t : Ko(t);
}
function Ft(e, t) {
  var r;
  t === void 0 && (t = []);
  const o = Ko(e), s = o === ((r = e.ownerDocument) == null ? void 0 : r.body), n = oe(o);
  return s ? t.concat(n, n.visualViewport || [], Lt(o) ? o : []) : t.concat(o, Ft(o));
}
function Yr(e, t, r) {
  return t === "viewport" ? ot(function(o, s) {
    ...
    const n = ut(o, !0, s === "fixed"), a = n.top + o.clientTop, l = n.left + o.clientLeft, i = fe(o) ? De(o) : { x: 1, y: 1 };
    ...
    const b = -n.scrollTop;
    return pe(a).direction === "rtl" && (d += st(s.clientWidth, a.clientWidth) - l), { width: l, height: i, x: d, y: b };
  }(_e(e)));
}
function Jr(e) {
...
function Qr(e) {
  const t = oe(e);
  let r = Jr(e);
  for (; r && Yc(r) && pe(r).position === "static"; )
    r = Jr(r);
  return r && ($e(r) === "html" || $e(r) === "body" && pe(r).position === "static" && !Yt(r)) ? t : r || function(o) {
    let s = ct(o);
    for (; fe(s) && !pr(s); ) {
      if (Yt(s))
        return s;
...
function Jc(e, t, r) {
  const o = fe(t), s = _e(t), n = ut(e, !0, r === "fixed", t);
  let a = { scrollLeft: 0, scrollTop: 0 };
  const l = { x: 0, y: 0 };
  if (o || !o && r !== "fixed")
    if (($e(t) !== "body" || Lt(s)) && (a = Et(t)), fe(t)) {
      const i = ut(t, !0);
...
const Qc = { getClippingRect: function(e) {
  ...
  const n = r === "clippingAncestors" ? function(d, b) {
    ...
    if (h)
      return h;
    let y = Ft(d).filter(($) => ke($) && $e($) !== "body"), c = null;
    const x = pe(d).position === "fixed";
    let k = x ? ct(d) : d;
    for (; ke(k) && !pr(k); ) {
      const $ = pe(k), T = Yt(k);
      (x ? T || c : T || $.position !== "static" || !c || !["absolute", "fixed"].includes(c.position)) ? c = $ : y = y.filter((S) => S !== k), k = ct(k);
    }
    return b.set(d, y), y;
  }(t, this._c) : [].concat(r), a = [...n, o], l = a[0], i = a.reduce((d, b) => {
    const h = Yr(t, b, s);
    return d.top = st(h.top, d.top), d.right = qr(h.right, d.right), d.bottom = qr(h.bottom, d.bottom), d.left = st(h.left, d.left), d;
  }, Yr(t, l, s));
  ...
  const i = { x: 0, y: 0 };
  if ((s || !s && o !== "fixed") && (($e(r) !== "body" || Lt(n)) && (a = Et(r)), fe(r))) {
    const d = ut(r);
    l = De(r), i.x = d.x + r.clientLeft, i.y = d.y + r.clientTop;
  }
...
}, getOffsetParent: Qr, getDocumentElement: _e, getScale: De, async getElementRects(e) {
  let { reference: t, floating: r, strategy: o } = e;
  const s = this.getOffsetParent || Qr, n = this.getDimensions;
  return { reference: Jc(t, await s(r), o), floating: { x: 0, y: 0, ...await n(r) } };
}, getClientRects: (e) => Array.from(e.getClientRects()), isRTL: (e) => pe(e).direction === "rtl" }, Zc = (e, t, r) => {
  const o = /* @__PURE__ */ new Map(), s = { platform: Qc, ...r }, n = { ...s.platform, _c: o };
  return Nc(e, t, { ...s, platform: n });
}, Oe = {
...
function Jt(e, t) {
  let r = Oe.themes[e] || {}, o;
  do
    o = r[t], typeof o > "u" ? r.$extend ? r = Oe.themes[r.$extend] || {} : (r = null, o = Oe[t]) : r = null;
  while (r);
  return o;
}
function Xc(e) {
...
const Gt = "__floating-vue__popper", Jo = () => C({
  name: "VPopper",
  provide() {
    return {
      [Gt]: {
  ...
  computed: {
    ...
    parentPopper() {
      var e;
      return (e = this[Gt]) == null ? void 0 : e.parentPopper;
    },
  ...
  methods: {
    ...
    async $_computePosition() {
      ...
      (this.distance || this.skidding) && e.middleware.push(Wc({
        mainAxis: this.distance,
        crossAxis: this.skidding
      }));
      const t = this.placement.startsWith("auto");
      if (t ? e.middleware.push(Dc({
        alignment: this.placement.split("-")[1] ?? ""
      })) : e.placement = this.placement, this.preventOverflow && (this.shift && e.middleware.push(qc({
      ...
      const r = await Zc(this.$_referenceNode, this.$_popperNode, e);
    ...
    $_scheduleHide(e = null, t = !1) {
      ...
      this.$_updateParentShownChildren(!1), this.$_hideInProgress = !0, clearTimeout(this.$_scheduleTimer), this.isShown && (Fe = this), t ? this.$_applyHide() : this.$_scheduleTimer = setTimeout(this.$_applyHide.bind(this), this.$_computeDelay("hide"));
    },
    $_computeDelay(e) {
      const t = this.delay;
    ...
    $_registerEventListeners(e, t, r) {
      this.$_events.push({ targetNodes: e, eventType: t, handler: r }), e.forEach((o) => o.addEventListener(t, r, Ge ? {
        passive: !0
      } : void 0));
    },
...
typeof document < "u" && typeof window < "u" && (Yo ? (document.addEventListener("touchstart", so, Ge ? {
  passive: !0,
  capture: !0
} : !0), document.addEventListener("touchend", r0, Ge ? {
  passive: !0,
  capture: !0
} : !0)) : (window.addEventListener("mousedown", so, !0), window.addEventListener("click", t0, !0)), window.addEventListener("resize", n0));
function so(e) {
...
function Qo(e, t = !1) {
  ...
  for (let o = ie.length - 1; o >= 0; o--) {
    const s = ie[o];
    try {
      const n = s.$_containsGlobalTarget = o0(s, e);
...
function no(e, t, r) {
  return r.closeAllPopover || r.closePopover && t || s0(e, r) && !t;
}
function s0(e, t) {
...
function l0(e, t, r, o, s, n) {
  return u(), g("div", {
    ...
    v(e.$slots, "default", Se(po(e.slotData)))
  ], 2);
}
const i0 = /* @__PURE__ */ fr(a0, [["render", l0]]);
function d0() {
...
const u0 = /* @__PURE__ */ us("data-v-b329ee4c");
io("data-v-b329ee4c");
const c0 = {
...
uo();
const p0 = /* @__PURE__ */ u0((e, t, r, o, s, n) => (u(), W("div", c0)));
Nt.render = p0;
...
}), g0 = ["id", "aria-hidden", "tabindex", "data-popper-placement"], h0 = {
  ref: "inner",
  class: "v-popper__inner"
}, b0 = /* @__PURE__ */ f("div", { class: "v-popper__arrow-outer" }, null, -1), m0 = /* @__PURE__ */ f("div", { class: "v-popper__arrow-inner" }, null, -1), v0 = [
  b0,
  m0
];
...
const Xo = /* @__PURE__ */ fr(f0, [["render", y0]]), es = {
  methods: {
    show(...e) {
...
const gr = /* @__PURE__ */ fr(w0, [["render", x0]]);
({
  ...gr
});
({
...
const _0 = k0;
const C0 = { class: "flex items-start" }, jf = /* @__PURE__ */ C({
  __name: "FwbTooltip",
  props: {
...
const $0 = "block text-sm font-medium text-gray-900 dark:text-gray-300", S0 = "w-4 h-4 rounded bg-gray-100 border-gray-300 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-600 dark:border-gray-500";
function T0() {
  const e = p(() => se(S0)), t = p(() => $0);
  return {
    checkboxClasses: e,
    labelClasses: t
  };
}
const P0 = { class: "flex gap-3 items-center justify-start" }, z0 = ["disabled"], Hf = /* @__PURE__ */ C({
  __name: "FwbCheckbox",
  props: {
    disabled: { type: Boolean, default: !1 },
    label: { default: "" },
...
}), F0 = "block w-full text-sm text-gray-900 border-[1px] border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400", I0 = "block mb-2 text-sm font-medium text-gray-900 dark:text-white", A0 = "flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600", B0 = "flex flex-col items-center justify-center pt-5 pb-6", O0 = "!-mb-2 text-sm text-gray-500 dark:text-gray-400";
function M0(e) {
  const t = p(() => se(
    F0,
    "text-" + e
  )), r = p(() => I0), o = p(() => A0), s = p(() => B0), n = p(() => O0);
  return {
    fileInpClasses: t,
    labelClasses: r,
...
const L0 = { key: 0 }, E0 = ["multiple"], N0 = /* @__PURE__ */ f("svg", {
  "aria-hidden": "true",
...
], -1), R0 = { key: 0 }, V0 = /* @__PURE__ */ f("span", { class: "font-semibold" }, "Click to upload", -1), j0 = { key: 1 }, H0 = ["multiple"], Df = /* @__PURE__ */ C({
  __name: "FwbFileInput",
  props: {
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: t }) {
    const r = e, o = p(() => qe(r.modelValue) ? r.modelValue.map((c) => c.name).join(", ") : r.modelValue instanceof FileList ? Array.from(r.modelValue).map((c) => c.name).join(",") : r.modelValue instanceof File && r.modelValue.name || ""), s = p({
      get() {
        return r.modelValue;
      },
      set(c) {
      ...
      c.dropzone ? (u(), g("div", {
        ...
        f("label", {
          ...
          f("div", {
            ...
            N0,
            s.value ? (u(), g("p", j0, "File: " + O(o.value), 1)) : (u(), g("div", R0, [
              f("p", {
                class: w(m(y))
              }, [
                V0,
  ...
  Success: "success",
  Error: "error"
}, D0 = "block mb-2 text-sm font-medium", G0 = "bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500", W0 = "cursor-not-allowed bg-gray-100", U0 = {
  lg: "p-4",
  md: "p-2.5 text-sm",
  sm: "p-2 text-sm"
}, q0 = "bg-green-50 border-green-500 dark:border-green-500 text-green-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 focus:ring-green-500 focus:border-green-500", K0 = "bg-red-50 border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500";
function Y0(e) {
  const t = p(() => {
    const o = e.validationStatus.value, s = o === He.Success ? q0 : o === He.Error ? K0 : "";
    return E(
      G0,
      s,
      U0[e.size.value],
    ...
    const o = e.validationStatus.value, s = o === He.Success ? "text-green-700 dark:text-green-500" : o === He.Error ? "text-red-700 dark:text-red-500" : "text-gray-900 dark:text-white";
    return E(D0, s);
  });
  return {
    inputClasses: t,
...
const J0 = { class: "flex relative" }, Q0 = {
  ...
  setup(e) {
    const t = e, r = Co(t, "modelValue"), { inputClasses: o, labelClasses: s } = Y0(J(t)), n = p(() => E(
      "mt-2 text-sm",
      t.validationStatus === He.Success ? "text-green-600 dark:text-green-500" : "",
      t.validationStatus === He.Error ? "text-red-600 dark:text-red-500" : ""
    ));
    return (a, l) => (u(), g("div", null, [
      ...
      f("div", J0, [
        a.$slots.prefix ? (u(), g("div", Q0, [
          v(a.$slots, "prefix")
        ])) : z("", !0),
        Te(f("input", ne(a.$attrs, {
      ...
      a.$slots.helper ? (u(), g("p", ep, [
        v(a.$slots, "helper")
      ])) : z("", !0)
    ]));
  }
}), tp = { class: "flex w-[100%] items-center" }, rp = ["disabled", "name", "value"], op = "w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600", sp = "m-2 mr-0 text-sm font-medium text-gray-900 dark:text-gray-300", Wf = /* @__PURE__ */ C({
  __name: "FwbRadio",
  props: {
    modelValue: { default: "" },
    name: { default: "" },
  ...
  setup(e, { emit: t }) {
    ...
    }), s = p(() => op), n = p(() => E(sp, r.disabled && "text-gray-400 dark:text-gray-500"));
    return (a, l) => (u(), g("label", tp, [
      Te(f("input", {
        "onUpdate:modelValue": l[0] || (l[0] = (i) => o.value = i),
        type: "radio",
        disabled: a.disabled,
...
}), np = "w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700", ap = "block mb-2 text-sm font-medium text-gray-900 dark:text-white", lp = {
  lg: "h-3 range-lg",
  md: "h-2 range-md",
  sm: "h-1 range-sm"
};
...
const dp = { class: "flex flex-col" }, up = ["step", "min", "max", "disabled"], cp = /* @__PURE__ */ C({
  __name: "FwbRange",
  props: {
    disabled: { type: Boolean, default: !1 },
  ...
  setup(e, { emit: t }) {
    ...
    }), { rangeClasses: s, labelClasses: n } = ip(J(r));
    return (a, l) => (u(), g("label", dp, [
      f("span", {
        class: w(m(n))
      }, O(a.label), 3),
      Te(f("input", {
...
const Uf = /* @__PURE__ */ ge(cp, [["__scopeId", "data-v-c4cfe3d4"]]), xe = {
  Success: "success",
  Error: "error"
}, pp = "block mb-2 text-sm font-medium", fp = "w-full text-gray-900 bg-gray-50 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500", gp = "cursor-not-allowed bg-gray-100", hp = "bg-transparent dark:bg-transparent border-b-2 border-gray-200 appearance-none dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer", bp = {
  lg: "p-4",
  md: "p-2.5 text-sm",
  sm: "p-2 text-sm"
}, mp = "bg-green-50 border-green-500 dark:border-green-500 text-green-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 focus:ring-green-500 focus:border-green-500", vp = "bg-red-50 border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500";
function yp(e) {
  const t = p(() => {
    const o = e.validationStatus.value, s = o === xe.Success ? mp : o === xe.Error ? vp : "", n = o === xe.Success ? "focus:border-green-500" : o === xe.Error ? "focus:border-red-500" : "";
    return E(
      fp,
      s,
      bp[e.size.value],
      e.disabled.value && gp,
      e.underline.value ? hp : "border border-gray-300 rounded-lg",
      e.underline.value && n
    );
  }), r = p(() => {
...
const wp = ["disabled"], xp = {
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: t }) {
    const r = e, o = Co(r, "modelValue", t), { selectClasses: s, labelClasses: n } = yp(J(r)), a = p(() => E(
      "mt-2 text-sm",
    ...
    return (l, i) => (u(), g("div", null, [
      f("label", null, [
        ...
        Te(f("select", {
          ...
          f("option", xp, O(l.placeholder), 1),
          (u(!0), g(Y, null, Me(l.options, (d, b) => (u(), g("option", {
            key: b,
            value: d.value
          }, O(d.name), 9, kp))), 128))
        ], 10, wp), [
      ...
      l.$slots.helper ? (u(), g("p", _p, [
        v(l.$slots, "helper")
      ])) : z("", !0)
    ]));
  }
}), Cp = "block w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600", $p = "block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-200 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500", Sp = "block mb-2 text-sm font-medium text-gray-900 dark:text-white", Tp = "block py-2 px-3 border-gray-200 dark:border-gray-600";
function Pp(e) {
  const t = p(() => se(
    $p,
    e ? "bg-white dark:bg-gray-800 border-none" : "border"
  )), r = p(() => Sp), o = p(() => e ? Cp : ""), s = p(() => Tp);
  return {
    textareaClasses: t,
    labelClasses: r,
    wrapperClasses: o,
...
const zp = ["rows", "placeholder"], Kf = /* @__PURE__ */ C({
  inheritAttrs: !1,
  __name: "FwbTextarea",
  props: {
    modelValue: { default: "" },
  ...
  setup(e, { emit: t }) {
    ...
    }), { textareaClasses: s, labelClasses: n, wrapperClasses: a, footerClasses: l } = Pp(r.custom);
...
}), Fp = "w-fit relative inline-flex items-center cursor-pointer", Ip = 'bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[""] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600', Ap = "ml-3 text-sm font-medium text-gray-900 dark:text-gray-300", Bp = {
...
function Mp(e) {
  const t = p(() => Fp), r = p(() => Ip), o = p(() => Bp[e.size.value]), s = p(() => Op[e.color.value]), n = p(() => Ap);
  return {
    labelClasses: t,
    toggleSize: o,
    toggleClasses: r,
...
const Lp = ["disabled"], Yf = /* @__PURE__ */ C({
  __name: "FwbToggle",
  props: {
    color: { default: "" },
    disabled: { type: Boolean, default: !1 },
  ...
  setup(e) {
    ...
    return (a, l) => (u(), W(te(m(n)), ne(a.$attrs, { class: m(s) }), {
      default: G(() => [
        v(a.$slots, "default")
      ]),
      _: 3
...
}), Np = ["src", "alt"], Rp = ["src", "alt"], Zf = /* @__PURE__ */ C({
  __name: "FwbImg",
  props: {
    caption: { default: "" },
    src: { default: "" },
  ...
  setup(e) {
    return ue(Lo, lt(e, "theme")), (r, o) => v(r.$slots, "default");
  }
});
function tg() {
  const e = ee(No, null);
...
export {
  eg as FlowbiteThemable,
  Cc as FlowbiteThemableChild,
  Jf as FwbA,
  jp as FwbAccordion,
  Hp as FwbAccordionContent,
  Dp as FwbAccordionHeader,
  Gp as FwbAccordionPanel,
  Wp as FwbAlert,
  Up as FwbAvatar,
  qp as FwbAvatarStack,
  Kp as FwbAvatarStackCounter,
  Yp as FwbBadge,
  Jp as FwbBreadcrumb,
  Qp as FwbBreadcrumbItem,
  aa as FwbButton,
  Zp as FwbButtonGroup,
  Xp as FwbCard,
  ef as FwbCarousel,
  Hf as FwbCheckbox,
  tf as FwbDropdown,
  Df as FwbFileInput,
  rf as FwbFooter,
  of as FwbFooterBrand,
  sf as FwbFooterCopyright,
  nf as FwbFooterIcon,
  af as FwbFooterLink,
  lf as FwbFooterLinkGroup,
  Qf as FwbHeading,
  Zf as FwbImg,
  Gf as FwbInput,
  df as FwbListGroup,
  uf as FwbListGroupItem,
  cf as FwbModal,
  pf as FwbNavbar,
  ff as FwbNavbarCollapse,
  gf as FwbNavbarLink,
  hf as FwbNavbarLogo,
  Xf as FwbP,
  bf as FwbPagination,
  ...
  yf as FwbSidebar,
  wf as FwbSidebarCta,
  xf as FwbSidebarDropdownItem,
  kf as FwbSidebarItem,
  _f as FwbSidebarItemGroup,
  Cf as FwbSidebarLogo,
  ...
  Tf as FwbTableCell,
  Pf as FwbTableHead,
  zf as FwbTableHeadCell,
  Ff as FwbTableRow,
  Af as FwbTabs,
  Kf as FwbTextarea,
  Bf as FwbTimeline,
  Of as FwbTimelineBody,
  Mf as FwbTimelineContent,
  Lf as FwbTimelineItem,
  Ef as FwbTimelinePoint,
  Nf as FwbTimelineTime,
  Rf as FwbTimelineTitle,
  Gr as FwbToast,
  Vf as FwbToastProvider,
  Yf as FwbToggle,
  jf as FwbTooltip,
  tg as useToast
};
